            ...
            child: Column(
              ...
              children: [
                ...
                data['imageUrl'] == '' && controller.profileImPath.isEmpty
                    ...
                    : Image.file(File(controller.profileImPath.value), width: 100, fit: BoxFit.cover,).box.roundedFull.clip(Clip.antiAlias).make(),
                10.heightBox,

                ourButton(onPress: (){controller.changeImage(context);}, color: redColor, textColor: whiteColor,title:"Change" ),
                    ...
                    : SizedBox(
                        ...
                        ourButton(onPress: ()async{
                          ...
                          if(data['password'] == controller.oldPassController.text){
                            ...
                            VxToast.show(context, msg: "type password to procees");
                            controller.isLoading(false);
                          }

                        }, color: redColor, textColor: whiteColor, title: "save")
